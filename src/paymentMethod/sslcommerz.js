...
module.exports.PaymentInit = async (req, res) => {
	try {
		const productInfo = {
			...
			currency: "BDT",
			tran_id: uuidv4(),
			success_url: "http://localhost:5000/order/ssl-payment/success",
			fail_url: "http://localhost:5000/order/ssl-payment/failure",
			cancel_url: "http://localhost:5000/order/ssl-payment/cancel",
			ipn_url: "http://localhost:5000/order/ssl-payment/ipn",
